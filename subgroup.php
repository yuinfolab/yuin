			    ...
			    if(!isset($_GET['getSubgPageId'])) {
			        ...
			        <div class="col-lg-4 col-md-6 course-item">
					    ...
					    <center>
					        ...
					        if($login == 1) {
					        // Eğer giriş yapıldıysa alt grup sayfasını aç
					        ?>
					        <a href="subgroup.php?getSubgPageId=<?=$subgroup['id'];?>"><button class="site-btn">Grup sayfasını gör</button></a>
					        <?php
					        
					        }else{
					        // Eğer giriş yapılmadıysa loginToProceed'e yönlendir
					        ?>
					        <a href="login.php?loginToProceed&goto=subgroup.php"><button class="site-btn">Giriş yapmak için tıklayın</button></a>
					        <?php
					        }
					        ?>
					    </center>
