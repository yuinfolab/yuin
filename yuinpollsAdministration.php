...
Buranın amacı yuin.yeditepe.edu.tr içerisinde Google Forms & StrawPoll benzeri bir sayfa oluşturmaktı fakat yönetim kadrosundaki üyeler için diğer siteleri kullanmanın daha pratik
olacağını düşündüğüm için bu YUIN Polls'u kodlamayı bıraktım. Belki ileride bu projenin geliştirilmesini devralacak bir kişi bu özelliği implement etmek isteyebilir.

Bu sayfayı geliştirebilirsiniz. GitHub üzerinden çalışmanızı takip ediyor olacağım.
...
<html lang="tr">
<head>
	<title>Yeditepe Üniversitesi Bilişim Kulübü | Anketleri yönet</title>
	<meta charset="UTF-8">
...
<body>
	...
	<nav class="nav-section">
		<div class="container">
			...
			<ul class="main-menu">
				...
				<li><a href="subgroup.php">Alt gruplar</a></li>
				<li><a href="gallery.php">Fotoğraf Galerisi</a></li>
				<li><a href="esergi.php">E-Sergi<sup>YENİ</sup></a></li>
				<li><a href="join.php">Hemen aramıza katıl</a></li>
	...
	<nav class="nav-section">
		<div class="container">
			...
			<ul class="main-menu">
				<li><a href="briefing.php">Brifing</a></li>
				<li><a href="magazine.php">Bilişim Dergisi</a></li>
				<li><a href="yuinpolls.php">Açık anketler</a></li>
				<li><a href="mydata.php">Kişisel bilgilerim</a></li>
	...
	<nav class="nav-section">
		<div class="container">
			...
			<ul class="main-menu">
				<li><a href="userAdministration.php">Üyeleri yönet</a></li>
				<li><a href="activityAdministration.php">Etkinlikleri yönet</a></li>
				<li><a href="yuinpollsAdministration.php">Anketleri yönet</a></li>
				<li><a href="adminsAdministration.php">YK üyelerini yönet</a></li>
				<li><a href="pagesAdministration.php">Sayfaları yönet</a></li>
				<li><a href="subgroupsAdministration.php">Alt grupları yönet</a></li>
			</ul>
		</div>
	</nav>
	<!-- Additional header section end -->
	...
	<div class="site-breadcrumb">
		<div class="container">
			<a href="#"><i class="fa fa-home"></i> Anasayfa</a> <i class="fa fa-angle-right"></i> YK Panel <i class="fa fa-angle-right"></i>
